        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistratedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    AccessTokenHash = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    RefreshTokenHash = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    AccessExpiresDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    RefreshExpiresDate = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_FileDetails_ImageId",
                        column: x => x.ImageId,
