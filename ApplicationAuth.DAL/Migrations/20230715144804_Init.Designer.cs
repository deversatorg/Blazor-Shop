...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationAuth.Domain.Entities.FIlesDetails.FileDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ApplicationAuth.Domain.Entities.Product.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ApplicationAuth.Domain.Entities.Product.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ApplicationAuth.Domain.Entities.Product.ProductInOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ApplicationAuth.Domain.Entities.Product.Product", b =>
                {
                    b.HasOne("ApplicationAuth.Domain.Entities.FIlesDetails.FileDetails", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("ApplicationAuth.Domain.Entities.Product.ProductInOrder", b =>
                {
                    b.HasOne("ApplicationAuth.Domain.Entities.Product.Order", "Order")
                        .WithMany("Products")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationAuth.Domain.Entities.Product.Product", "Product")
                        .WithMany()
